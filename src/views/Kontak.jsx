      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4 container mx-auto">
        ...
        <div className="p-4 flex flex-col justify-center md:w-3/4 sm:w-full">
          ...
          <p className="text_kontak mb-5">
            ...
            memiliki pertanyaan, masukan, atau sekadar ingin berbagi pengalaman,
            jangan ragu untuk menghubungi kami. Tim kami siap memberikan bantuan
            dan menjawab pertanyaan Anda sebaik mungkin.
          </p>
          <div className="">
            ...
            <div className="icon_link">
              ...
              >
                ...
                <div>
                  <span className="text_kontak_icon ml-3">+62 85718793077</span>
                </div>
              </a>
            </div>
