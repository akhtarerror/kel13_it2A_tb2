...
const Blog = () => {
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-1 mt-5 container mb-20 mx-auto">
        ...
        <div className="col-span-1 sm:col-span-2 p-4">
          ...
          <p className="mb-5 text_blog">
            sebagai salah satu kota yang menyimpan banyak nilai sejarah, Jakarta
            memiliki banyak sekali tempat dan bangunan bersejarah. Salah satunya
            adalah Museum Galeri Nasional yang berfokus pada karya seni rupa
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 container mx-auto mb-30">
