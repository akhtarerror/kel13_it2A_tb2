  ...
  return (
    <footer className="py-4 mt-20 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
          ...
          <div>
            ...
            <ul class="flex flex-row justify-center space-x-3">
              ...
              <a href="https://twitter.com/galerinasional_/" target="_blank">
                <div className="mt-3 icon_bg_footer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
              ...
              <a href="https://www.tiktok.com/@galerinasional/" target="_blank">
                <div className="mt-3 icon_bg_footer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
      ...
      <p className="absolute bottom-0 left-0 w-full py-2 text-center copyright">
        Museum Galeri Nasional Indonesia &copy; 2023
      </p>
    </footer>
  );
};
